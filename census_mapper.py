""" census_mapper.py is a utility program to easily
read and convert ACS census data for geopandas usage.
Source: https://github.com/agaidus/census_data_extraction/
The program, originally written in Python 2.7, has been
refreshed for compatibility with Python 3.8 """

# Author: Andrew Gaidus
# Python 3 Updater: William Xie
